...
CREATE TABLE customers (idcustomers INT AUTO_INCREMENT, company VARCHAR(45), email VARCHAR(45), fkiddialing_codefromcustomers INT UNSIGNED, fkidgender INT, fkidcustomer_status INT, name VARCHAR(45), phone INT, password VARCHAR(45), password_hash VARCHAR(45), surname VARCHAR(45), created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, INDEX fkiddialing_codefromcustomers_idx (fkiddialing_codefromcustomers), INDEX fkidcustomer_status_idx (fkidcustomer_status), INDEX fkidgender_idx (fkidgender), PRIMARY KEY(idcustomers)) ENGINE = INNODB;
