...
CREATE TABLE artworks (idartworks INT AUTO_INCREMENT, fkidartists INT, fkidartwork_style INT, fkidartwork_type INT, description TEXT, photo VARCHAR(255), updated_at DATETIME NOT NULL, created_at DATETIME NOT NULL, INDEX fkidartists_idx (fkidartists), INDEX fkidartwork_style_idx (fkidartwork_style), INDEX fkidartwork_type_idx (fkidartwork_type), PRIMARY KEY(idartworks)) ENGINE = INNODB;
...
CREATE TABLE customers (idcustomers INT AUTO_INCREMENT, company VARCHAR(45), email VARCHAR(45), fkiddialing_codefromcustomers INT UNSIGNED, fkidgender INT, fkidcustomer_status INT, name VARCHAR(45), phone INT, password VARCHAR(45), password_hash VARCHAR(45), surname VARCHAR(45), created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, INDEX fkidcustomer_status_idx (fkidcustomer_status), INDEX fkiddialing_codefromcustomers_idx (fkiddialing_codefromcustomers), INDEX fkidgender_idx (fkidgender), PRIMARY KEY(idcustomers)) ENGINE = INNODB;
