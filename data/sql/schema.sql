...
CREATE TABLE customers (idcustomers INT AUTO_INCREMENT, company VARCHAR(45), dialing_code VARCHAR(45), email VARCHAR(45), fkidgender INT, fkidcustomer_status INT, name VARCHAR(45), phone INT, password VARCHAR(45), password_hash VARCHAR(45), surname VARCHAR(45), created_at DATETIME, updated_at DATETIME, INDEX fkidcustomer_status_idx (fkidcustomer_status), INDEX fkidgender_idx (fkidgender), PRIMARY KEY(idcustomers)) ENGINE = INNODB;
...
CREATE TABLE prospects (idprospects INT AUTO_INCREMENT, company VARCHAR(45), dialing_code VARCHAR(45), email VARCHAR(45), fkidgenderfromprospect INT, fkidgeolocationfromprospect INT, name VARCHAR(45), phone INT, surname VARCHAR(45), password VARCHAR(45), password_hash VARCHAR(45), step INT, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, INDEX fkidgenderfromprospect_idx (fkidgenderfromprospect), INDEX fkidgeolocationfromprospect_idx (fkidgeolocationfromprospect), PRIMARY KEY(idprospects)) ENGINE = INNODB;
