...
$logger = new sfFileLogger($this->dispatcher, array_merge(array('auto_shutdown' => false), array (
  'level' => 'debug',
  'file' => 'C:\\inetpub\\wwwroot\\artworks\\log/signup_dev.log',
)));
$this->factories['logger']->addLogger($logger);
  ...
  'cache_dir' => 'C:\\inetpub\\wwwroot\\artworks\\cache\\signup\\dev\\i18n',
  'lifetime' => 31556926,
  'prefix' => 'C:\\inetpub\\wwwroot\\artworks\\apps\\signup/i18n',
));
...
'auto_shutdown' => false, 'session_id' => $this->getRequest()->getParameter('symfony'),
  ...
  'automatic_cleaning_factor' => 0,
  'cache_dir' => 'C:\\inetpub\\wwwroot\\artworks\\cache\\signup\\dev\\template',
  'lifetime' => 86400,
  'prefix' => 'C:\\inetpub\\wwwroot\\artworks\\apps\\signup/template',
)));
...
$this->setMailerConfiguration(array_merge(array('class' => sfConfig::get('sf_factory_mailer', 'sfMailer')), sfConfig::get('sf_factory_mailer_parameters', array (
  ...
  array (
    ...
    'param' => 
    array (
      'host' => 'smtp.pictime.fr',
      'port' => 25,
      'encryption' => NULL,
      'username' => 'mohamed.belazar',
      'password' => 'jsyicoqf',
    ),
  ),
))));
